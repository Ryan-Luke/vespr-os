...
async function seed() {
  ...
  const agentData = [
    ...
    { name: "Sam", role: "CRM Manager", avatar: "CM", pixelAvatarIndex: 5, provider: "anthropic", model: "Claude Haiku", status: "working", teamId: sales.id, currentTask: "Syncing new leads to GHL", skills: ["CRM Sync", "Data Cleanup", "Pipeline Management"], tasksCompleted: 1205, costThisMonth: 3.5 },
    ...
    { name: "Finley", role: "Bookkeeper", avatar: "BK", pixelAvatarIndex: 2, provider: "anthropic", model: "Claude Haiku", status: "idle", teamId: finance.id, currentTask: null, skills: ["Bookkeeping", "Categorization", "Reconciliation", "QuickBooks"], isTeamLead: true, tasksCompleted: 890, costThisMonth: 5.2 },
    ...
    { name: "Drew", role: "Order Tracker", avatar: "OT", pixelAvatarIndex: 5, provider: "anthropic", model: "Claude Haiku", status: "working", teamId: fulfillment.id, currentTask: "Monitoring 23 active shipments", skills: ["Order Tracking", "Shipping Updates", "Delay Detection"], tasksCompleted: 3421, costThisMonth: 1.2 },
  ]
