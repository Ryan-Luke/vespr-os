...
async function seed() {
  ...
  // Insert agents
  const agentData = [
    { name: "Maya", role: "Content Writer", avatar: "MW", pixelAvatarIndex: 0, provider: "anthropic", model: "Claude Sonnet", status: "working", teamId: marketing.id, currentTask: "Writing blog post on Q1 growth strategies", skills: ["Writing", "SEO", "Research", "Content Strategy"], tasksCompleted: 142, costThisMonth: 28.5 },
    ...
    { name: "Jordan", role: "Lead Researcher", avatar: "LR", pixelAvatarIndex: 3, provider: "anthropic", model: "Claude Opus", status: "working", teamId: sales.id, currentTask: "Researching prospects in fintech vertical", skills: ["Web Research", "Lead Scoring", "CRM Integration", "Data Enrichment"], tasksCompleted: 312, costThisMonth: 45.0 },
    ...
    { name: "Automation Expert", role: "Automation Architect", avatar: "AE", pixelAvatarIndex: 0, provider: "anthropic", model: "Claude Sonnet", status: "working", teamId: operations.id, currentTask: "Building invoice processing workflow", skills: ["n8n", "Workflow Design", "API Integration", "Error Handling"], tasksCompleted: 78, costThisMonth: 12.0 },
    ...
    { name: "Finley", role: "Bookkeeper", avatar: "BK", pixelAvatarIndex: 2, provider: "custom", model: "n8n Workflow", status: "idle", teamId: finance.id, currentTask: null, skills: ["Bookkeeping", "Categorization", "Reconciliation", "QuickBooks"], tasksCompleted: 890, costThisMonth: 5.2 },
    ...
    { name: "Casey", role: "Customer Support", avatar: "CS", pixelAvatarIndex: 4, provider: "anthropic", model: "Claude Haiku", status: "working", teamId: fulfillment.id, currentTask: "Responding to 3 support tickets", skills: ["Customer Service", "Ticket Triage", "Knowledge Base", "Escalation"], tasksCompleted: 1847, costThisMonth: 18.9 },
  ...
  await db.insert(schema.tasks).values([
    ...
    { title: "Build invoice processing workflow", description: "Create n8n automation for scanning and categorizing invoices", assignedAgentId: agent("Automation Expert").id, teamId: operations.id, status: "in_progress", priority: "high" },
