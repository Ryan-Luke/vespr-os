    ...
    <div className="h-full overflow-y-auto">
      <div className="max-w-5xl mx-auto p-6 space-y-6">
        ...
        <div>
          ...
          {/* Progress bar */}
          <div className="h-1 rounded-full progress-glass overflow-hidden mt-3 max-w-xs">
            <div className="h-full bg-teal-500 transition-all" style={{ width: `${(unlockedCount / totalCount) * 100}%` }} />
          </div>
        </div>
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isUnlocked
                    ? "glass-card border-border hover:border-muted-foreground/30"
                    : "bg-muted/20 border-border/50"
                )}
              >
                {/* Header */}
                <div className="flex items-start gap-3">
                  <div className={cn("h-12 w-12 rounded-lg flex items-center justify-center text-2xl shrink-0", isUnlocked ? "bg-teal-500/10" : "bg-muted/60")}>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {isUnlocked ? (
                        ...
                        <span className="text-[9px] uppercase tracking-wider font-medium text-amber-400 badge-glass border border-amber-500/30 rounded px-1.5 py-0.5">Earn to hire</span>
                      )}
                    </div>
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          isUnlocked ? cn(tierStyle.bg, tierStyle.border) : "bg-stone-700/30 border-stone-700"
                        )}
                      >
                        <div className="flex items-center gap-2">
                ...
                {isUnlocked && (
                  <Link
                    ...
                    className="mt-4 inline-flex items-center justify-center w-full h-8 rounded-lg btn-teal text-[12px] font-medium transition-colors"
                  >
                    Hire {arch.label}
                  </Link>
                )}
