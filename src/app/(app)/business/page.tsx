    ...
    <div className="h-full overflow-y-auto">
      <div className="p-6 max-w-3xl space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3 bg-[#1a1a2e] border border-[rgba(255,255,255,0.08)] rounded-xl rounded-xl p-3">
          ...
          <div className="flex items-center gap-2">
            {editing ? (
              ...
              <button onClick={() => setEditing(true)} className="h-7 px-3 rounded-md text-xs btn-secondary text-muted-foreground transition-colors flex items-center gap-1.5">
        ...
        <div className="grid gap-px bg-border rounded-md overflow-hidden md:grid-cols-3">
          <div className="bg-[#1a1a2e] border border-[rgba(255,255,255,0.08)] rounded-xl p-3">
              ...
              <div className="space-y-2">
                {businessDocs.map((doc) => (
                  <Link
                    ...
                    className="flex items-center gap-3 rounded-md border border-border bg-[#1a1a2e] border border-[rgba(255,255,255,0.08)] rounded-xl p-4 hover:border-muted-foreground/20 transition-colors group"
                  >
